...
# Welcome to the Boulder programming language interpreter v0.1.0
...
#
# Known issues: 
# ==>   Currently typing parameters does not work with the additional character
#       after parameter parentheses for NESTED function calls, single calls work as expected.
# ==>   Defining functions is currently unsupported
#
# Roadmap:
        ...
        try:    
            ...
            for line in program_lines:
                ...
                while len(components) > 0 and (index - 1) >= 0:
                    ...
                    # last parentheses
                    if(len(components[index].split(")")) == 2):
